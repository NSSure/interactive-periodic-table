  ...
  <span class="content">
    <div class="periodic-table-wrapper mh-100">
      <div class="periodic-table container">
        <div class="badge-panel" v-if="element" style="margin: 50px 0;">
          <div class="badge">
            <div class="badge-swatch" v-bind:style="{ backgroundColor: element.color }"></div>
            <h4>{{element.name}}</h4>
          </div>
          <div class="badge-content" style="background-color: rgba(0.0,0.0,0.0,0.0);">
            {{element.summary}}
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      element: null,
      ignoreKeys: ['xpos', 'ypos', 'spectral_img', 'source']
    };
  },
  methods: {
